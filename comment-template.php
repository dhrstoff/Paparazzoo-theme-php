...
<?php if ($comments) : ?>
    <h3 id="comments"><?php comments_number('Geen reacties', 'Een reactie', '% reacties' );?> op &#8220;<?php the_title(); ?>&#8221;</h3>
        ...
        <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
            ...
            <?php else : ?>
                ...
                <p><input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="40" tabindex="2" />
                    <label for="email"><small>E-mail (niet zichtbaar) <?php if ($req) echo "(verplicht)"; ?></small></label></p>
            ...
            <!--<p><small><strong>XHTML:</strong> <?php _e('Je kan volgende codes gebruiken&#58;'); ?> <?php echo allowed_tags(); ?></small></p>-->
